...
func (rm *resourceManager) sdkFind(
	...
	found := false
	for _, elem := range resp.Tags {
		_ = elem
		if elem.Key != nil {
			ko.Spec.Key = elem.Key
		} else {
			ko.Spec.Key = nil
		}
		found = true
...
func (rm *resourceManager) newListRequestPayload(
	r *resource,
) (*svcsdk.ListRoleTagsInput, error) {
	res := &svcsdk.ListRoleTagsInput{}
...
func (rm *resourceManager) sdkCreate(
	...
	var resp *svcsdk.TagRoleOutput
	_ = resp
	resp, err = rm.sdkapi.TagRole(ctx, input)
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.TagRoleInput, error) {
	res := &svcsdk.TagRoleInput{}
...
func (rm *resourceManager) sdkDelete(
	...
	var resp *svcsdk.UntagRoleOutput
	_ = resp
	resp, err = rm.sdkapi.UntagRole(ctx, input)
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.UntagRoleInput, error) {
	res := &svcsdk.UntagRoleInput{}

	if r.ko.Spec.RoleName != nil {
		res.RoleName = r.ko.Spec.RoleName
	}
	if r.ko.Spec.TagKeys != nil {
		res.TagKeys = aws.ToStringSlice(r.ko.Spec.TagKeys)
	}
