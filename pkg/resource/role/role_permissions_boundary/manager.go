...
func key(r *resource) string {
	return *r.ko.Spec.PermissionsBoundary
}
...
func (rm *resourceManager) Get(
	...
	if len(seeds) == 0 {
		parent.Spec.PermissionsBoundary = nil
		return nil
	}
	...
	parent.Spec.PermissionsBoundary = found.ko.Spec.PermissionsBoundary
	return nil
}
...
func convertFromParent(parent *svcapitypes.Role) []resource {
	if parent.Spec.PermissionsBoundary == nil {
		return nil
	}
	ko := &svcapitypes.RolePermissionsBoundary{}
	ko.Spec.PermissionsBoundary = parent.Spec.PermissionsBoundary
