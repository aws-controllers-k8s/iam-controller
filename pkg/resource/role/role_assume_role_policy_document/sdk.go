...
var (
	...
	_ = strings.ToLower("")
	_ = &svcsdk.Client{}
	_ = &svcapitypes.RoleAssumeRolePolicyDocument{}
...
func (rm *resourceManager) sdkFind(
	...
	return rm.customFindAssumeRolePolicyDocument(ctx, r)
}
...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "UpdateAssumeRolePolicy", err)
	if err != nil {
		return nil, err
	}
