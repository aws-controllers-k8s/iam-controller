...
const (
	FinalizerString = "finalizers.iam.services.k8s.aws/ServiceLinkedRole"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("servicelinkedroles")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ServiceLinkedRole{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ServiceLinkedRole),
	}
}
