...
// +kubebuilder:rbac:groups=iam.services.k8s.aws,resources=servicelinkedroles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.services.k8s.aws,resources=servicelinkedroles/status,verbs=get;update;patch
