...
const (
	FinalizerString = "finalizers.iam.services.k8s.aws/Policies"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("policies")
